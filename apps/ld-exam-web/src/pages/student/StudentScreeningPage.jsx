...
const LD_RESULT = {
  dyslexia:    { label: 'Dyslexia', color: 'text-purple-700', bg: 'bg-purple-50 border-purple-200', icon: 'ðŸ“–' },
  dysgraphia:  { label: 'Dysgraphia', color: 'text-orange-700', bg: 'bg-orange-50 border-orange-200', icon: 'âœï¸' },
  dyscalculia: { label: 'Dyscalculia', color: 'text-green-700', bg: 'bg-green-50 border-green-200', icon: 'ðŸ”¢' },
  mixed:       { label: 'Mixed LD', color: 'text-red-700', bg: 'bg-red-50 border-red-200', icon: 'ðŸ”€' },
  not_detected:{ label: 'No LD Detected', color: 'text-slate-600', bg: 'bg-slate-50 border-slate-200', icon: 'âœ…' },
};
...
const StudentScreeningPage = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-500 font-medium">Preparing your assessmentâ€¦</p>
        </div>
      </div>
    );
  }

  // â”€â”€ Empty / no questions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (phase === 'empty') {
    return (
  ...
  // â”€â”€ Intro â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (phase === 'intro') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 space-y-2">
            ...
            <ul className="text-sm text-slate-600 space-y-1.5">
              <li>ðŸ“ {questions.length} short questions</li>
              <li>â±ï¸ About 5â€“10 minutes</li>
              <li>ðŸŽ¯ No right or wrong â€” just answer honestly</li>
              <li>ðŸ“Š We'll personalise your learning plan after</li>
            </ul>
          </div>
  ...
  // â”€â”€ Quiz â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (phase === 'quiz' && q) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full p-8 space-y-6">
          ...
          >
            {current + 1 === questions.length ? 'Finish Assessment' : 'Next Question â†’'}
          </button>
        </div>
      </div>
    );
  ...
  // â”€â”€ Submitting â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (phase === 'submitting') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center space-y-4">
          <div className="w-12 h-12 border-4 border-blue-500 border-t-transparent rounded-full animate-spin mx-auto" />
          <p className="text-slate-600 font-bold">Analysing your responsesâ€¦</p>
