...
const LEVEL_INFO = {
  1: { label: 'Starter', emoji: 'ðŸŒ±', bg: 'bg-green-50', border: 'border-green-200', accent: 'text-green-700', btn: 'bg-green-600 hover:bg-green-700', desc: 'Basic letters, sounds & number counting' },
  2: { label: 'Basic', emoji: 'ðŸ“˜', bg: 'bg-blue-50', border: 'border-blue-200', accent: 'text-blue-700', btn: 'bg-blue-600 hover:bg-blue-700', desc: 'Simple reading, CVC words & arithmetic' },
  3: { label: 'Intermediate', emoji: 'ðŸš€', bg: 'bg-orange-50', border: 'border-orange-200', accent: 'text-orange-700', btn: 'bg-orange-500 hover:bg-orange-600', desc: 'Comprehension, fractions & sentence building' },
  4: { label: 'Advanced', emoji: 'â­', bg: 'bg-purple-50', border: 'border-purple-200', accent: 'text-purple-700', btn: 'bg-purple-600 hover:bg-purple-700', desc: 'Grammar mastery & problem solving' },
  5: { label: 'Mastery', emoji: 'ðŸ†', bg: 'bg-amber-50', border: 'border-amber-200', accent: 'text-amber-700', btn: 'bg-amber-500 hover:bg-amber-600', desc: 'Critical thinking & complex maths' },
};
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                {!locked && (
                  ...
                  >
                    {lvl.bestScore != null ? 'Retry â†’' : 'Start â†’'}
                  </button>
                )}
              </div>
      ...
      <div className="mt-6 bg-blue-50 rounded-xl border border-blue-100 p-4">
        <p className="text-sm font-bold text-blue-800 mb-1">â„¹ï¸ How it works</p>
        <ul className="text-xs text-blue-700 space-y-1 list-disc list-inside">
          <li>20 multiple-choice questions per test</li>
          <li>25-minute timer â€” auto-submits when time runs out</li>
