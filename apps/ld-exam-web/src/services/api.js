...
export const recommendationAPI = {
  getClassRecs: (classId) => api.get(`/ld/recommendations/class/${classId}`),
  generate: (userId, audience) => api.post('/ld/recommendations/generate', { userId, audience }),
};
...
export const messagesAPI = {
  ...
  send: (receiverId, body) => api.post('/ld/messages', { receiverId, body }),
};
...
export const complianceAPI = {
  ...
  getConsentStatus: () => api.get('/ld/compliance/consent-status'),
  requestDataExport: () => api.post('/ld/compliance/data-export'),
  deleteAccount: () => api.delete('/ld/compliance/delete-account'),
};
