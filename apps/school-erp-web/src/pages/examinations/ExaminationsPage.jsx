...
export default function ExaminationsPage() {
  ...
  async function rephraseRemark() {
    ...
    setRephrasing(true);
    try {
      const { data } = await api.post('/school/communications/ai/rephrase', { text: rephrase.text, type: 'remark' });
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-xl shadow p-5 space-y-3">
          ...
          {[
            { icon: 'ðŸ“…', label: 'Exam Planner', desc: 'Term-wise, distributed via parent portal' },
            { icon: 'âš¡', label: 'Quick Marks Entry', desc: '5 min/student via AnsApp concept' },
            { icon: 'ðŸ¤–', label: 'AI Result Analysis', desc: '360Â° performance insights' },
            { icon: 'ðŸ“„', label: 'Digital Report Card', desc: 'CBSE/IGCSE formats, downloadable' },
            { icon: 'ðŸ“Š', label: 'Performance Chart', desc: 'Auto-generated graphical view' },
            { icon: 'âœ¨', label: 'AI-Rephrased Remarks', desc: 'Professional teacher comments' },
          ].map(f => (
      ...
      <div className="bg-white rounded-xl shadow p-5">
        ...
        <div className="grid grid-cols-4 md:grid-cols-8 gap-2">
          {[
            { grade: 'A1', range: '91â€“100', color: 'bg-green-100 text-green-800' },
            { grade: 'A2', range: '81â€“90', color: 'bg-green-100 text-green-700' },
            { grade: 'B1', range: '71â€“80', color: 'bg-blue-100 text-blue-700' },
            { grade: 'B2', range: '61â€“70', color: 'bg-blue-100 text-blue-600' },
            { grade: 'C1', range: '51â€“60', color: 'bg-amber-100 text-amber-700' },
            { grade: 'C2', range: '41â€“50', color: 'bg-amber-100 text-amber-600' },
            { grade: 'D',  range: '33â€“40', color: 'bg-orange-100 text-orange-700' },
            { grade: 'E',  range: '0â€“32',  color: 'bg-red-100 text-red-700' },
          ].map(g => (
