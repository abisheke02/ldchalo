...
const NAV_ADMIN = [
  ...
  { label: 'Content CMS', path: '/admin/cms', icon: '✏️' },
  { label: 'Messages', path: '/messages', icon: '💬' },
  { label: 'Settings', path: '/settings', icon: '⚙️' },
];
...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex bg-[var(--bg-main)] overflow-hidden transition-colors duration-300">
      {/* Sidebar */}
      <aside className="w-64 bg-slate-900 dark:bg-[#000000] flex flex-col flex-shrink-0 border-r border-slate-200 dark:border-slate-800 transition-colors duration-300 overflow-y-auto">
