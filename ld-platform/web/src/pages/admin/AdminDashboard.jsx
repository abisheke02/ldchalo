          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              {[
                ...
                <div key={kpi.label} title={kpi.label} className="bg-[var(--bg-card)] rounded-[2.5rem] p-8 border border-[var(--border-main)] card-shadow hover:shadow-2xl hover:border-blue-500/30 transition-all group overflow-hidden relative cursor-help">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
              <div title="Pie chart of LD Classification Variance" className="bg-[var(--bg-card)] rounded-[3rem] p-10 border border-[var(--border-main)] card-shadow hover:shadow-lg transition-shadow">
              ...
              <div title="Bar chart of Active Enrollments by Institution" className="bg-[var(--bg-card)] rounded-[3rem] p-10 border border-[var(--border-main)] card-shadow hover:shadow-lg transition-shadow">
                <div className="flex items-center justify-between mb-10">
            ...
            {/* Table */}
            <div title="Global Subscriptions Table" className="bg-[var(--bg-card)] rounded-[3rem] border border-[var(--border-main)] card-shadow hover:shadow-lg transition-shadow overflow-hidden mb-12 cursor-help">
