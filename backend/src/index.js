...
// ══════════════════════════════════════════════════════════════════════════════
if (env.demoMode) {
  const { demoAuth, demoScreening, demoPractice, demoTests, demoAnalytics } = require('./middleware/demoMode');
  ...
  // Teacher routes (demo data)
  app.use('/api/teacher', requireAuth, demoTeacher);
