// Recommendations Routes â€” Phase 4
...
// GET /api/recommendations/me â€” student gets their own, teacher gets teacher recs
...
// GET /api/recommendations/class/:classId â€” teacher gets class-level recommendations
router.get(
  '/class/:classId',
  requireAuth,
...
// POST /api/recommendations/generate â€” admin triggers fresh generation
router.post(
  '/generate',
  requireAuth,
  requireRole('admin'),
