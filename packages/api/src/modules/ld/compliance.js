// DPDP (India Data Protection) & Compliance Routes â€” Phase 6
...
// â”€â”€â”€ POST /api/compliance/consent â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ POST /api/compliance/data-export â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
router.post('/data-export', requireAuth, async (req, res, next) => {
  try {
    ...
    // Immediately compile export (simple version â€” returns JSON inline)
...
// â”€â”€â”€ DELETE /api/compliance/delete-account â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Right to be forgotten â€” anonymises PII, keeps aggregate data
router.delete('/delete-account', requireAuth, async (req, res, next) => {
  try {
    ...
    // Anonymise user â€” don't hard-delete to preserve referential integrity
    await query(
      `UPDATE users
...
// â”€â”€â”€ GET /api/compliance/consent-status â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Helper: compile all user data for export â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
