...
// POST /api/students/profile â€” complete onboarding profile
...
// POST /api/students/join-school â€” student joins class via code
...
// GET /api/students/me â€” get own profile
...
// GET /api/students/:id â€” teacher views a student profile
router.get('/:id', requireAuth, async (req, res, next) => {
  try {
    // Allow if user is teacher/admin OR if the ID matches the current user
    if (req.user.role !== 'teacher' && req.user.role !== 'admin' && req.user.userId !== req.params.id) {
...
// POST /api/students/activity â€” log daily session activity
