...
const LEVEL_LABELS = ['', 'Level 1 â€” Starter', 'Level 2 â€” Basic',
  'Level 3 â€” Intermediate', 'Level 4 â€” Advanced', 'Level 5 â€” Mastery'];

// â”€â”€â”€ GET /api/reports/student/:studentId â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
router.get('/student/:studentId', requireAuth, requireRole('teacher', 'admin'), async (req, res, next) => {
  try {
    ...
    // â”€â”€â”€ Student Profile â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    doc.moveDown(2);
    ...
    const profileData = [
      ['Name', student.name || 'â€”'],
      ['Age', student.age ? `${student.age} years` : 'â€”'],
      ['Class', student.class_grade ? `Grade ${student.class_grade}` : 'â€”'],
      ['Current Level', LEVEL_LABELS[student.current_level] || 'â€”'],
    ...
    // â”€â”€â”€ LD Classification â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    doc.moveDown(1.5);
    ...
    // â”€â”€â”€ Score Trend â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (trendResult.rows.length) {
      ...
      trendResult.rows.forEach((day) => {
        const bar = 'â–ˆ'.repeat(Math.round((day.avg_score || 0) / 5));
        doc.text(`${day.date}: ${day.avg_score}%  ${bar}`);
      });
    }

    // â”€â”€â”€ Level Progress â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if (testResult.rows.length) {
      ...
      testResult.rows.forEach((t) => {
        const status = t.ever_passed ? 'âœ“ Passed' : 'âœ— Not yet passed';
        doc.text(`${LEVEL_LABELS[t.level]}: ${Math.round(t.best_score || 0)}% â€” ${status}`);
      });
    }

    // â”€â”€â”€ Error Patterns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€â”€ AI Recommendations â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
