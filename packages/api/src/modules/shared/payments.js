// Razorpay Payment Routes â€” Phase 6
// School subscription checkout (INR, UPI/cards/netbanking)
// Flow: Create order â†’ Razorpay checkout on frontend â†’ verify signature â†’ activate subscription
...
// Razorpay instance â€” keys loaded from .env
...
const PLANS = {
  basic: { paise_per_student: 9900,  label: 'â‚¹99/student/year',  max_students: 30  },
  pro:   { paise_per_student: 29900, label: 'â‚¹299/student/year', max_students: 200 },
};

// â”€â”€â”€ POST /api/payments/create-order â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
router.post('/create-order', requireAuth, requireRole('admin', 'teacher'), async (req, res, next) => {
  try {
    ...
    res.json({
      ...
      totalFormatted: `â‚¹${(totalPaise / 100).toLocaleString('en-IN')}`,
    });
  } catch (err) {
    next(err);
  }
...
// â”€â”€â”€ POST /api/payments/verify â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ GET /api/payments/plans â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ GET /api/payments/subscription/:schoolId â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
